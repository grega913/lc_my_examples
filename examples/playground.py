...
def intro():
    st.title("Welcome to LangChain Lessons")
...
def blogFromWiki():
    ...
    st.write(
        """
        This is from Lesson 5 project: Wikipedia to Blog Post
        [Here are detailed instructions](https://app.alejandro-ao.com/topics/project-wikipedia-to-blog-post/)
        """
    )
